...
Finally, as I will demonstrate in <+LaterSection+>, weak indefinites can be SC subjects.
So, supposing we take \posscite{heycock2012specification} analysis to be true, the question changes from ``Why is the indefinite X a licit SC subject, while Y is illicit?'' to ``Why can X receive a strong interpretation, while Y cannot?''.
