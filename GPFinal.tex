...
\begin{exe}
	\ex
	\begin{xlist}
		\ex A spider has eight legs and many eyes. (generic/specific)
		\ex One spider has eight legs and many eyes. (*generic/specific)\hfill\parencite{kayne2015one}		
	\end{xlist}
\end{exe}
...
As stated, the contition that indefinites can be SC subjects if they contain but do not comprise an F-marked constituentthis is a necessary condition but not sufficient.
For instance, consider the the example of an over-informative answer to a polar question in (\ref{ex:Overinform}) \parencite[adapted from][]{mikkelsen2008specification}.
\begin{exe}
...
\begin{exe}
	\ex\label{ex:RomeroSCSubj} The price that Fred thought was \$1.29 \hfill\parencite[712]{romero2005concealed}
\end{exe}
...
\begin{exe}
	...
	\ex\label{ex:RomeroSC2} The price that Fred thought was \$1.29 was the price of milk.\hfill\parencite[712]{romero2005concealed}
\end{exe}
