...
\ex.
\a.\label{ex:BadCT} Who is the lead singer of The Spiders from Mars?\\
\#The lead singer of The Spiders from Mars is Ziggy Stardust.
\b.\label{ex:GoodCT} Who is the singer of The Spiders from Mars?\\
The lead singer of The Spiders from Mars is Ziggy Stardust.
...
Futhermore, the SC in \ref{ex:GoodCT} must be uttered with intonational stress on \textit{lead} to be felicitous.
