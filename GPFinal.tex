...
\begin{abstract}
  ...
  I further argue that this constraint can be derived from a general constraint on discourse that requires both novel and presupposed content in utterances.
\end{abstract}
\doublespacing
